...
export function CreateAdsBanner() {
    return (
        ...
        <div className="bg-[#2A2634] px-8 py-6 flex justify-between items-center">
          <div>
            <strong className="text-2xl text-white font-black">Tem uma recomendação para fazer?</strong>
            <span className="text-zinc-400 block">Publique um anúncio e ajude outros nomades!</span>
          </div>
          {/* escurecer o botão */}
