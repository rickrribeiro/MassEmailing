				...
				{false && props.articles.length > 0 &&
					props.articles.map((article, key) => (
						<Article key={key}>
							...
							<SocialActions>
								{/* <button onClick={(event) => likeHandler(event, key, props.ids[key])} className={props.articles[key].likes.whoLiked.indexOf(props.user.email) >= 0 ? "active" : null}> TODO QUANDO TIVER AUTH*/}
								<button onClick={(event) => likeHandler(event, key, props.ids[key])} className={props.articles[key].likes.whoLiked.indexOf('EMAIL@EMAIL') >= 0 ? "active" : null}>
